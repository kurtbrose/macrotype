# Generated via: macrotype macrotype/pyi_extract.py -o __macrotype__/macrotype/pyi_extract.pyi
# Do not edit by hand
...
def _make_literal_overload(fn: Callable[..., Any], args: tuple[Any, ...], kwargs: dict[Any, Any], result: Any) -> Callable[..., Any]: ...
...
def _collect_type_params(fn: Callable[..., Any], hints: dict[str, Any], exclude_params: set[str] | None) -> tuple[list[str], set[type]]: ...

def _collect_decorators(decorators: list[str] | None, fn: Callable[..., Any], *, skip_final: bool) -> tuple[list[str], set[type]]: ...
...
class PyiFunction(PyiNamedElement):
    ...
    def render(self, indent: int) -> list[str]: ...
    @classmethod
    def from_function(cls, fn: Callable[..., Any], decorators: list[str] | None, exclude_params: set[str] | None, *, skip_final: bool, globalns: dict[str, Any] | None, localns: dict[str, Any] | None) -> PyiFunction: ...
...
class _ModuleBuilder:
    def __init__(self, mod: module, line_map: dict[str, int] | None) -> None: ...
    ...
    def build(self, *, header_comments: list[str] | None, comments: dict[int, str] | None) -> PyiModule: ...
