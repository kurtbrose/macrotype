...
def load_module_from_path(
    path: Path, type_checking: bool, module_name: None | str
) -> ModuleType: ...
def load_module_from_code(
    code: str, name: str, type_checking: bool, module_name: None | str
) -> ModuleType: ...
def stub_lines(module: ModuleType, strict: bool) -> list[str]: ...
...
def process_file(
    src: Path, dest: None | Path, command: None | str, stub_overlay_dir: None | Path, strict: bool
) -> Path: ...
def process_directory(
    directory: Path,
    out_dir: None | Path,
    command: None | str,
    stub_overlay_dir: None | Path,
    strict: bool,
) -> list[Path]: ...
