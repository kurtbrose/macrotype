...
def _collect_decorators(decorators: list[str] | None, fn: Callable, *, skip_final: bool) -> tuple[list[str], set[type]]: ...
...
class PyiFunction(PyiNamedElement):
    ...
    def render(self, indent: int) -> list[str]: ...
    @classmethod
    def from_function(cls, fn: Callable, decorators: list[str] | None, exclude_params: set[str] | None, *, skip_final: bool, globalns: dict[str, Any] | None, localns: dict[str, Any] | None) -> PyiFunction: ...
